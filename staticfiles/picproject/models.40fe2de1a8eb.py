...
class picproj(models.Model):
    user=models.ForeignKey(User , on_delete=models.SET_NULL , null=True , blank=True)
    pic_image=models.FileField(upload_to="pic/",max_length=250,null=True,default=None)
    image_title=models.CharField(max_length=100,null=True,default=None)
